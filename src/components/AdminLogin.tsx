          ...
          <Form>
            ...
            >
              <Box>
                ...
                <Typography
                  mb='1.375rem'
                  fontSize='1.25rem' // Kept font size for better readability
                  fontWeight={500} // Increased font weight for emphasis
                  color={Colors.primary.main}
                >
                  ¡Bienvenido!
                </Typography>
                ...
                <Box mb='1rem' mt='0.75rem'>
                  <TextField
                    ...
                    sx={{
                      '& input': {
                        p: '0.8125rem 1.0625rem',
                        fontSize: '1.125rem', // Kept font size for better readability
                        lineHeight: '100%',
                      },
                    }}
